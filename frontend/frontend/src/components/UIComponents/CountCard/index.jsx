...
const CountCard = ({ title, subtitle, count, icon }) => {
  return (
    <div className="relative flex-1 min-w-[250px] p-4 overflow-hidden bg-white shadow-lg rounded-2xl">
      {icon && <img alt={title} src={icon} className="absolute w-40 h-40 mb-4 -right-20 -bottom-8 opacity-20" />}
      <div className="w-auto space-y-3 relative z-10">
